...
# so a loop is required to keep the service down. The loop will run until you manualy kill it. Requires PS running with
# admin privs. Admin escalation should be trivial in most case -Robert
